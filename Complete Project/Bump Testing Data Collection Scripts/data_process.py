...
Description: Similar to the data_process.py in the real time data collection script, however, here the data being processed is
             from a csv file. The data is read from a csv file into a list. A new csv file is then created, where the raw Xbee
             frames are processed to convert the raw acceleration values in hex bytes to float m/s^2 values. The values are then stored
             in the new csv file. 
"""
