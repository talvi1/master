...
df = pd.read_csv('30km_both_wheels_accelerometer_signal.csv', sep='|')
...
accel_z_1 = dc_blocker(Accel_Z_Device1)
accel_z_2 = dc_blocker(Accel_Z_Device2)
mov_avg_accel_0 = moving_average(accel_z_0, 15)
mov_avg_accel_1 = moving_average(accel_z_1, 15)
mov_avg_accel_2 = moving_average(accel_z_2, 15)
integ_0 = simpsons_method(mov_avg_accel_0)
integ_1 = simpsons_method(mov_avg_accel_1)
integ_2 = simpsons_method(mov_avg_accel_2)


#print(mov_avg_accel)
plt.figure(1)
plt.plot(mov_avg_accel_0)
plt.figure(2)
plt.plot(mov_avg_accel_1)
plt.figure(3)
